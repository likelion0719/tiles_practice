...
<div class="mainbar">
	...
	<div class="page-head">
		...
		<div class="bread-crumb pull-right">
			...
			<!-- Divider -->
			<span class="divider">/</span> <a href="#" class="bread-current">Widgets</a>
		</div>
			...
			<div class="row">
					...
					<div class="widget wlightblue">
						...
						<div class="widget-content">
							...
							<ul class="activity">
								...
								<li>
									<!-- Icon with avtivity  --> <i class="fa fa-envelope-o red"></i>
									<strong>Ashok</strong> Mailed you on 3/12/2032
								</li>

								<li><i class="fa fa-share violet"></i> <strong>Go
										to america</strong> Shared by <strong>Ravi Kumar</strong></li>

								<li><i class="fa fa-sign-in green"></i> <strong>Admin</strong>
									Signed in on 2/4/2012</li>

								<li><i class="fa fa-money lightblue"></i> <strong>Babu
										Kumar</strong> made $5000 today.</li>

								<li><i class="fa fa-upload blue"></i> <strong>Font
										Asesome Mp3</strong> got uploaded by <strong>Admin</strong>.</li>

								<li><i class="fa fa-user ornage"></i> <strong>Kumarasamy</strong>
									joined the site on 3/5/2012.</li>

								<li><i class="fa fa-bookmark green"></i> You Bootmarked the
									site <strong>Google</strong>.</li>

								<li><i class="fa fa-plus red"></i> <strong>Admin</strong>
									added the article <strong>Why not now?</strong>.</li>
						...
						<div class="widget-foot">
							<button class="btn pull-right btn-xs btn-danger">Clear
								All</button>
							<div class="clearfix"></div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="widget wblue">
						...
						<div class="widget-content">
							<div class="gmap">
								<iframe height="300" frameborder="0" scrolling="no"
							...
							<div class="padd">
								...
								<div class="user">
									...
									<div class="user-details">
										...
										<p>Maecenas quis tristique turpis. Nulla facilisi. Duis
											sed velit at ac ultrices magna. Aliquam consequat, purus
											vitae auctor ullamcorper.</p>
										<a href="#" class="btn btn-xs btn-success"><i
											class="fa fa-envelope-o"></i></a> <a href="#"
											class="btn btn-info btn-xs"><i class="fa fa-user"></i></a>
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="form quick-post">
									...
									<form class="form-horizontal" role="form">
										...
										<div class="form-group">
											<label class="control-label col-md-2" for="sitename">
												Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" id="sitename"
													placeholder="Metro King">
											</div>
										</div>
										<!-- description -->
										<div class="form-group">
											<label class="control-label col-lg-2" for="sitedescription">
												Description</label>
											<div class="col-lg-7">
										...
										<div class="form-group">
											...
											<div class="col-lg-7">
												<div class="checkbox">
													<label> <input type="checkbox" value="value1"
														checked="checked"> Something
													</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-7">
												<div class="checkbox">
													<label> <input type="checkbox"> Any One Can
														Register
													</label>
												</div>
											</div>
											...
											<div class="col-lg-7">
												<div class="radio">
													<label><input type="radio" name="optionsRadios"
														id="optionsRadios1" value="option1"> Jan 18,2012</label>
												</div>
												<div class="radio">
													<label><input type="radio" name="optionsRadios"
														id="optionsRadios2" value="option2"> Jan 18,2012</label>
												</div>
												<div class="radio">
													<label><input type="radio" name="optionsRadios"
														id="optionsRadios3" value="option3"> Jan 18,2012</label>
												</div>
											</div>
										</div>
	...
	<div class="slide-content">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab2">
				...
				<p>Aliquam dui libero, pharetra nec venenatis in, scelerisque
					quis odio. In hac habitasse platea dictumst. Etiam porta placerat
					turpis, eget fermentum neque egestas at. Vestibulum ullamcorper,
					augue a sollicitudin vestibulum, orci purus semper felis, lobortis
					consequat nisi nunc eu enim.</p>
			</div>
